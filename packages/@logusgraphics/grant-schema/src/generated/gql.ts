...
export function graphql(
  source: 'query CheckUsername($username: String!) {\n  checkUsername(username: $username) {\n    available\n    username\n  }\n}'
 ...
 */
export function graphql(
  source: 'mutation RefreshSession($accessToken: String!, $refreshToken: String!) {\n  refreshSession(accessToken: $accessToken, refreshToken: $refreshToken) {\n    accessToken\n    refreshToken\n  }\n}'
): (typeof documents)['mutation RefreshSession($accessToken: String!, $refreshToken: String!) {\n  refreshSession(accessToken: $accessToken, refreshToken: $refreshToken) {\n    accessToken\n    refreshToken\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation Register($input: RegisterInput!) {\n  register(input: $input) {\n    accessToken\n    refreshToken\n    account {\n      id\n      name\n      slug\n      type\n    }\n  }\n}'
): (typeof documents)['mutation Register($input: RegisterInput!) {\n  register(input: $input) {\n    accessToken\n    refreshToken\n    account {\n      id\n      name\n      slug\n      type\n    }\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation CreateGroup($input: CreateGroupInput!) {\n  createGroup(input: $input) {\n    id\n    name\n    description\n    createdAt\n    updatedAt\n  }\n}'
): (typeof documents)['mutation CreateGroup($input: CreateGroupInput!) {\n  createGroup(input: $input) {\n    id\n    name\n    description\n    createdAt\n    updatedAt\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation DeleteGroup($id: ID!, $scope: Scope!) {\n  deleteGroup(id: $id, scope: $scope) {\n    id\n    name\n    description\n    createdAt\n    updatedAt\n  }\n}'
): (typeof documents)['mutation DeleteGroup($id: ID!, $scope: Scope!) {\n  deleteGroup(id: $id, scope: $scope) {\n    id\n    name\n    description\n    createdAt\n    updatedAt\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetGroups($scope: Scope!, $page: Int, $limit: Int, $sort: GroupSortInput, $search: String, $ids: [ID!], $tagIds: [ID!]) {\n  groups(\n    scope: $scope\n    page: $page\n    limit: $limit\n    sort: $sort\n    search: $search\n    ids: $ids\n    tagIds: $tagIds\n  ) {\n    groups {\n      id\n      name\n      description\n      createdAt\n      updatedAt\n      permissions {\n        id\n        name\n        action\n        tags {\n          id\n          name\n          color\n          isPrimary\n        }\n      }\n      tags {\n        id\n        name\n        color\n        isPrimary\n      }\n    }\n    totalCount\n    hasNextPage\n  }\n}'
): (typeof documents)['query GetGroups($scope: Scope!, $page: Int, $limit: Int, $sort: GroupSortInput, $search: String, $ids: [ID!], $tagIds: [ID!]) {\n  groups(\n    scope: $scope\n    page: $page\n    limit: $limit\n    sort: $sort\n    search: $search\n    ids: $ids\n    tagIds: $tagIds\n  ) {\n    groups {\n      id\n      name\n      description\n      createdAt\n      updatedAt\n      permissions {\n        id\n        name\n        action\n        tags {\n          id\n          name\n          color\n          isPrimary\n        }\n      }\n      tags {\n        id\n        name\n        color\n        isPrimary\n      }\n    }\n    totalCount\n    hasNextPage\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation UpdateGroup($id: ID!, $input: UpdateGroupInput!) {\n  updateGroup(id: $id, input: $input) {\n    id\n    name\n    description\n    createdAt\n    updatedAt\n  }\n}'
 ...
 */
export function graphql(
  source: 'mutation DeleteOrganization($id: ID!) {\n  deleteOrganization(id: $id) {\n    id\n    name\n    slug\n    createdAt\n    updatedAt\n  }\n}'
): (typeof documents)['mutation DeleteOrganization($id: ID!) {\n  deleteOrganization(id: $id) {\n    id\n    name\n    slug\n    createdAt\n    updatedAt\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetOrganizations($page: Int, $limit: Int, $sort: OrganizationSortInput, $search: String, $ids: [ID!]) {\n  organizations(\n    page: $page\n    limit: $limit\n    sort: $sort\n    search: $search\n    ids: $ids\n  ) {\n    organizations {\n      id\n      name\n      slug\n      createdAt\n      updatedAt\n      tags {\n        id\n        name\n        color\n        isPrimary\n      }\n    }\n    totalCount\n    hasNextPage\n  }\n}'
): (typeof documents)['query GetOrganizations($page: Int, $limit: Int, $sort: OrganizationSortInput, $search: String, $ids: [ID!]) {\n  organizations(\n    page: $page\n    limit: $limit\n    sort: $sort\n    search: $search\n    ids: $ids\n  ) {\n    organizations {\n      id\n      name\n      slug\n      createdAt\n      updatedAt\n      tags {\n        id\n        name\n        color\n        isPrimary\n      }\n    }\n    totalCount\n    hasNextPage\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation UpdateOrganization($id: ID!, $input: UpdateOrganizationInput!) {\n  updateOrganization(id: $id, input: $input) {\n    id\n    name\n    slug\n    createdAt\n    updatedAt\n  }\n}'
): (typeof documents)['mutation UpdateOrganization($id: ID!, $input: UpdateOrganizationInput!) {\n  updateOrganization(id: $id, input: $input) {\n    id\n    name\n    slug\n    createdAt\n    updatedAt\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation CreatePermission($input: CreatePermissionInput!) {\n  createPermission(input: $input) {\n    id\n    name\n    action\n    description\n    createdAt\n    updatedAt\n  }\n}'
): (typeof documents)['mutation CreatePermission($input: CreatePermissionInput!) {\n  createPermission(input: $input) {\n    id\n    name\n    action\n    description\n    createdAt\n    updatedAt\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation DeletePermission($id: ID!, $scope: Scope!) {\n  deletePermission(id: $id, scope: $scope) {\n    id\n    name\n    action\n    description\n    createdAt\n    updatedAt\n  }\n}'
): (typeof documents)['mutation DeletePermission($id: ID!, $scope: Scope!) {\n  deletePermission(id: $id, scope: $scope) {\n    id\n    name\n    action\n    description\n    createdAt\n    updatedAt\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetPermissions($scope: Scope!, $page: Int, $limit: Int, $sort: PermissionSortInput, $search: String, $ids: [ID!], $tagIds: [ID!]) {\n  permissions(\n    scope: $scope\n    page: $page\n    limit: $limit\n    sort: $sort\n    search: $search\n    ids: $ids\n    tagIds: $tagIds\n  ) {\n    permissions {\n      id\n      name\n      action\n      description\n      tags {\n        id\n        name\n        color\n        isPrimary\n      }\n      createdAt\n      updatedAt\n    }\n    totalCount\n    hasNextPage\n  }\n}'
 ...
 */
export function graphql(
  source: 'mutation UpdatePermission($id: ID!, $input: UpdatePermissionInput!) {\n  updatePermission(id: $id, input: $input) {\n    id\n    name\n    action\n    description\n    createdAt\n    updatedAt\n  }\n}'
 ...
 */
export function graphql(
  source: 'mutation DeleteUser($id: ID!, $scope: Scope!) {\n  deleteUser(id: $id, scope: $scope) {\n    id\n    name\n    createdAt\n    updatedAt\n  }\n}'
): (typeof documents)['mutation DeleteUser($id: ID!, $scope: Scope!) {\n  deleteUser(id: $id, scope: $scope) {\n    id\n    name\n    createdAt\n    updatedAt\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetUsers($scope: Scope!, $page: Int, $limit: Int, $sort: UserSortInput, $search: String, $ids: [ID!], $tagIds: [ID!]) {\n  users(\n    scope: $scope\n    page: $page\n    limit: $limit\n    sort: $sort\n    search: $search\n    ids: $ids\n    tagIds: $tagIds\n  ) {\n    users {\n      id\n      name\n      createdAt\n      updatedAt\n      roles {\n        id\n        name\n        tags {\n          id\n          name\n          color\n          isPrimary\n        }\n      }\n      tags {\n        id\n        name\n        color\n        isPrimary\n      }\n    }\n    totalCount\n    hasNextPage\n  }\n}'
): (typeof documents)['query GetUsers($scope: Scope!, $page: Int, $limit: Int, $sort: UserSortInput, $search: String, $ids: [ID!], $tagIds: [ID!]) {\n  users(\n    scope: $scope\n    page: $page\n    limit: $limit\n    sort: $sort\n    search: $search\n    ids: $ids\n    tagIds: $tagIds\n  ) {\n    users {\n      id\n      name\n      createdAt\n      updatedAt\n      roles {\n        id\n        name\n        tags {\n          id\n          name\n          color\n          isPrimary\n        }\n      }\n      tags {\n        id\n        name\n        color\n        isPrimary\n      }\n    }\n    totalCount\n    hasNextPage\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation UpdateUser($id: ID!, $input: UpdateUserInput!) {\n  updateUser(id: $id, input: $input) {\n    id\n    name\n    createdAt\n    updatedAt\n  }\n}'
