...
export const OrganizationProjectAuditAction = {
  CREATE: 'CREATE',
  DELETE: 'DELETE',
} as const;

export type OrganizationProjectAuditActionType =
  (typeof OrganizationProjectAuditAction)[keyof typeof OrganizationProjectAuditAction];
