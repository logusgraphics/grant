...
export const removeOrganizationRoleInputSchema = z.object({
  organizationId: idSchema,
  roleId: idSchema,
});

export const removeOrganizationRoleParamsSchema = z.object({
  input: removeOrganizationRoleInputSchema,
});
